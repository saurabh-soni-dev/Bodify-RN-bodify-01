...
const analyticsOverviewList = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        amount: '60%',
        description: 'Increase of Retention Rate',
        progress: '2',
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        amount: '3,527',
        description: 'Increase of Total Earnings',
        progress: '8',
      },
      {
        id: 23,
...
export {analyticsOverviewList, chartInformationList, graphFilters};
